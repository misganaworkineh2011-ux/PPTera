...
// Theme 8: Cyber Neon - Futuristic cyberpunk theme with electric neon colors and glitch effects
const cyberNeon: Theme = {
  id: "cyber-neon",
  name: "Cyber Neon",
  description: "A futuristic cyberpunk theme with electric blue, neon pink, and lime accents, glitch frames, and holographic effects",
  category: "bold",
  colors: {
    background: "#0a0a0f",
  ...
  fonts: {
    heading: { family: "'Inter', sans-serif", weight: 700, letterSpacing: "-0.01em" },
    body: { family: "'Inter', sans-serif", weight: 400, lineHeight: "1.7" },
    caption: { family: "'Inter', sans-serif", weight: 500, size: "0.875rem" },
  },
  design: {
    borderRadius: { small: "0.25rem", medium: "0.5rem", large: "1rem", full: "9999px" },
    shadows: {
  ...
  slideStyles: {
    title: {
      background: "linear-gradient(135deg, #0a0a0f 0%, #0f0f18 40%, #151520 100%)",
      pattern: "radial-gradient(ellipse at 20% 80%, rgba(0, 255, 255, 0.15) 0%, transparent 50%), radial-gradient(ellipse at 80% 20%, rgba(255, 0, 255, 0.12) 0%, transparent 45%), radial-gradient(ellipse at 50% 50%, rgba(173, 255, 47, 0.08) 0%, transparent 60%)",
    },
    content: {
    ...
    image: {
      ...
      overlay: "linear-gradient(to top, rgba(10, 10, 15, 0.95) 0%, transparent 60%)",
    },
  },
  preview: {
  ...
  overlay: "linear-gradient(180deg, rgba(10, 10, 15, 0.4) 0%, rgba(10, 10, 15, 0.2) 100%)",
  cardBox: {
...
export const themes: Theme[] = [elegantNoir, arcticFrost, sunsetGradient, oceanDepths, auroraBorealis, emberForge, midnightGarden, cyberNeon];
