...
// Theme 10: Corporate Clean - Premium professional theme with elegant typography
// Uses DM Sans for a modern, sophisticated look
export const corporateClean: Theme = {
  ...
  design: {
    ...
    spacing: { tight: "0.5rem", normal: "1.5rem", relaxed: "2.5rem" },
  },
  slideStyles: {
    title: {
      background: "linear-gradient(145deg, #ffffff 0%, #fafbfc 40%, #f7fafc 100%)",
      pattern: "radial-gradient(ellipse at 75% 15%, rgba(49, 130, 206, 0.04) 0%, transparent 55%), radial-gradient(ellipse at 25% 85%, rgba(66, 153, 225, 0.03) 0%, transparent 50%)",
    },
    content: {
  ...
  overlay: "linear-gradient(180deg, rgba(255, 255, 255, 0.25) 0%, rgba(255, 255, 255, 0.08) 100%)",
  cardBox: {
