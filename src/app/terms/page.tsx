...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Read PPTera's terms of service. Understand user rights, responsibilities, and policies for our AI platform.",
    url: "/terms",
    type: "website",
    images: [
      {
  ...
  twitter: {
    ...
    description: "Understand the rules and policies for using PPTera's AI platform.",
