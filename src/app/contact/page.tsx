...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Contact Us - Get Support for AI PowerPoint Generator | PPTera",
    description: "Contact PPTera support team. Get help with AI PowerPoint generation, billing, or partnership inquiries.",
    url: "/contact",
    type: "website",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Contact Us - Get Support | PPTera",
    description: "Contact PPTera support team. Get help with AI PowerPoint generation or partnership inquiries.",
