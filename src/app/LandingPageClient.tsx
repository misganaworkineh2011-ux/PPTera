...
export function LandingPageClient({ currentLang }: LandingPageClientProps) {
  ...
  return (
    <div className="landing-page landing-page-container relative min-h-screen bg-[#070b14] font-sans text-slate-100 selection:bg-teal-400 selection:text-[#070b14] overflow-x-hidden">
      {/* Global atmosphere: one aurora the whole page floats over */}
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute -top-48 left-[6%] h-[560px] w-[560px] rounded-full bg-emerald-600/[0.16] blur-[150px]" />
        <div className="absolute top-[28%] right-[-160px] h-[520px] w-[520px] rounded-full bg-teal-500/[0.13] blur-[150px]" />
        <div className="absolute bottom-[-200px] left-[30%] h-[560px] w-[560px] rounded-full bg-teal-600/[0.10] blur-[160px]" />
        <div
