...
export default function TemplatesStickyHeader() {
        ...
        if (sticky) {
          setStickyTitleContent(
            <>
              ...
              <h1 className="text-xl font-bold tracking-tight text-[#1e3a8a] whitespace-nowrap">Templates</h1>
            </>
          );
        } else {
    ...
    <>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-[#1e3a8a]">Templates</h1>
        </div>
        <div className="flex items-center gap-3">
