...
export default function InspirationPageClient({ currentLang = "en" }: InspirationPageClientProps) {
  ...
  return (
    <div className="landing-page min-h-screen bg-white">
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl text-center">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed animate-fade-in-up [animation-delay:200ms]">
            {t.inspirationHeroDesc || "Browse through hundreds of professionally designed presentations to spark your creativity. Discover stunning templates for business pitches, marketing campaigns, educational content, and more."}
          </p>
      ...
      {/* Tips Section - Additional content for SEO */}
      <section className="relative px-6 py-24 bg-gradient-to-br from-slate-50 to-white">
