...
export const metadata: Metadata = {
  ...
  description: "Discover expert tips, design guides, and best practices for creating stunning presentations with PPT Master. Learn how to leverage AI powerpoint generator tools for professional slides.",
  ...
  openGraph: {
    ...
    description: "Expert tips and guides for creating stunning presentations with AI powerpoint generator tools. Learn design principles, best practices, and presentation techniques.",
