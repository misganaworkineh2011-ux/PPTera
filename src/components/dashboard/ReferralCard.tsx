...
export function ReferralCard() {
  ...
  const shareOnTwitter = () => {
    const text = `I'm using PPT Master to create amazing AI presentations! Sign up with my link and we both get 10 free credits 🎁`;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-gradient-to-br from-purple-50 to-pink-50 p-6">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h3 className="font-bold text-zinc-900">Invite Friends, Earn Credits</h3>
          <p className="text-sm text-zinc-600">
            Get {data.creditsPerReferral} credits for each friend who signs up
          </p>
        </div>
      </div>
          ...
          onClick={() => {
            if (navigator.share) {
              navigator.share({
                ...
                text: "Sign up with my link and we both get 10 free credits!",
