...
export default function TopBar({ credits = 0, onSearch }: TopBarProps) {
  ...
  return (
    <header className="md:sticky top-0 z-30 flex h-14 lg:h-20 items-center justify-between bg-[#F8F9FA] dark:bg-zinc-900 px-3 sm:px-4 lg:px-8 border-b border-slate-100/50 dark:border-zinc-800 backdrop-blur-sm gap-2 lg:gap-4">
