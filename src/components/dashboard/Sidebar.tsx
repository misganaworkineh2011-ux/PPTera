      ...
      <div className="border-t border-slate-100 dark:border-zinc-800">
        ...
        <div className={cn(
          ...
          <button
            ...
            className="flex w-full items-center justify-between rounded-2xl border border-slate-200 bg-white dark:bg-zinc-800 dark:border-zinc-700 p-2.5 lg:p-3 shadow-sm transition hover:border-[#14b8a6] hover:shadow-md"
          >
            <div className="flex items-center gap-2 lg:gap-3 flex-1 min-w-0">
              ...
              <div className="flex flex-col items-start overflow-hidden flex-1 min-w-0">
                <div className="flex items-center justify-between w-full gap-2">
                  <span className="truncate text-sm font-bold text-[#0f766e] dark:text-white">
                    {user?.fullName || "User"}
                  </span>
                ...
                <span className="truncate text-xs font-semibold text-[#14b8a6] mt-0.5">
